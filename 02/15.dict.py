...
# get() 객체함수를 사용하는 이유 : 값 객체가 없는경우 None을 반환받을수있음
# print(phones['도우넛'])
v = phones.get('도우넛')
if v is None:
    print('도우넛 키를 가진 값은 없습니다.')

# setDefault()는 get()와 차이점은 존재하지않는경우 Default 값이 저장된다
v = phones.setdefault('둘리', '555-5555-5555')
print(v)
v = phones.setdefault('도우넛' '666-6666-6666')
print(v)
